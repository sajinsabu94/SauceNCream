...
namespace WindowsFormsApplication2
{
    public partial class Form4 : Form
    {
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            String dat = dateTimePicker1.Value.Date.ToString("dd-MM-yyyy");
            ...
            if (count > 0)
            {
                try
                {
                    ...
                    cmd.CommandText = "select tb1.Item,tb1.Qnty,tb2.Rate,tb2.Vat,(tb1.Qnty*tb2.Rate) as Amount from (Select Item,sum(Qnty) as Qnty from Bill where Dat = '" + dat + "' Group By Item) AS tb1 inner join (Select PdNam,Rate,Vat from StockDetls UNION Select Item,Rate,Vat from Others) AS tb2 on tb1.Item = tb2.PdNam";
                    conn.Open();
